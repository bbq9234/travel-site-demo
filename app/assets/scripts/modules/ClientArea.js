...
class ClientArea {
  constructor() {
    ...
    this.file = document.querySelector(".client-area__input")
  ...
  sendRequest() {
    Axios.post('https://clever-jones-db530b.netlify.com/.netlify/functions/secret-area', {
      ...
      this.contentArea.innerHTML = `<p class="client-area__error">That secret phrase is incorrect. Please try again.</p>`
      this.field.value = ''
      this.field.focus()
    })
  }
